...
export const FEATURES: FeatureRow[] = [
  ...
  { area: 'Shadow-Clock', feature: 'Long Day, Twin Suns, Searing Light, Sunstruck, Shadowstep', status: 'planned', since: 'M2' },
  ...
  { area: 'Combat & Weapons', feature: 'Solar Flare, Heliograph, Scarab, Stakes, Prism, Noon Bell', status: 'planned', since: 'M2' },
  ...
  { area: 'Controls', feature: 'Flick Noon Cut and cooldown ring', status: 'shipped', since: 'M1' },
  ...
  { area: 'Graphics/Performance', feature: 'Dynamic resolution and debug overlay', status: 'shipped', since: 'M1' },
  ...
  { area: 'Platform/Ads', feature: 'Real ad SDK, audio, portal build', status: 'planned', since: 'M2' },
]
