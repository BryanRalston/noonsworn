...
export const FEATURES: FeatureRow[] = [
  ...
  { area: 'Shadow-Clock', feature: 'Long Day, Twin Suns, Searing Light, Sunstruck, Shadowstep', status: 'planned', since: 'M3' },
  ...
  { area: 'Platform/Ads', feature: 'Procedural audio', status: 'shipped', since: 'M2' },
