...
- Move: WASD or arrow keys. On a touch screen, a floating stick on the left.
- Noon Cut: Space, Shift, or right mouse. The cut goes toward the cursor if the mouse moved in the last two seconds, otherwise toward your movement. Touch: the Cut button, or a quick flick on the right side.
- Level-up: click a card, or press 1, 2, or 3.
- Pause: Esc, P, or the pause button. The game also pauses when the tab is hidden.
- Restart after the run ends: R, Enter, or tap.
